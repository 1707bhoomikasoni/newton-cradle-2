...
chain2=new Rope(bobObject2.body,{x:240,y:50})
chain3=new Rope(bobObject3.body,{x:280,y:50})
chain4=new Rope(bobObject4.body,{x:320,y:50})
chain5=new Rope(bobObject5.body,{x:360,y:50})
}
